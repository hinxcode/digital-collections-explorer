...
* Acknowledging and respecting intellectual contributions appropriately
...
* Plagiarism or failure to properly attribute work and ideas
...
* Project events and conferences
* Academic publications and presentations based on this work
* Any other forums created by the project team which use this project
...
As a research-oriented project, we hold additional standards:

* **Attribution**: Properly cite sources, give credit to contributors, and
  acknowledge intellectual contributions
* **Reproducibility**: Share code, data, and methods openly when possible
* **Transparency**: Be clear about limitations, assumptions, and potential biases
* **Collaboration**: Foster constructive academic collaboration and knowledge sharing
